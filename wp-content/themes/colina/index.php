...
<body>
    <main>
        ...
        <section class="about-and-documents">
            ...
            <section class="about-us">
                <div class="up">
                    <div class="message">
                        <div class="title">
                            <?php if ($about_title): ?><h3><?php echo esc_html($about_title); ?></h3><?php endif; ?>
                            <?php if ($about_subtitle): ?><h2><?php echo esc_html($about_subtitle); ?></h2><?php endif; ?>
                        </div>
                        <?php if ($about_text): ?><p><?php echo $about_text; ?></p><?php endif; ?>
                    </div>
                    <?php if ($about_btn_text && $about_btn_link): ?>
                        <a class="btn" href="<?php echo esc_url($about_btn_link); ?>"><?php echo esc_html($about_btn_text); ?></a>
                    <?php endif; ?>
                ...
                <section class="documents-section">
                    <div class="section-header">
                        <?php if ($documents_btn_text && $documents_btn_link): ?>
                            <a href="<?php echo esc_url($documents_btn_link); ?>" class="btn-more-info btn"><?php echo esc_html($documents_btn_text); ?></a>
                        <?php else: ?>
                            <a href="#" class="btn-more-info btn">Más información</a>
                        <?php endif; ?>
                        <div class="section-title-container">
                            <?php if ($documents_title): ?><h2 class="section-title"><?php echo esc_html($documents_title); ?></h2><?php endif; ?>
                            <?php if ($documents_subtitle): ?><h3 class="section-subtitle"><?php echo esc_html($documents_subtitle); ?></h3><?php endif; ?>
                            <?php if ($documents_description): ?><p class="section-description"><?php echo esc_html($documents_description); ?></p><?php endif; ?>
                        </div>
                    ...
                    <?php if ($documents_count > 1): ?>
                        <div class="documents-swiper-container">
                            ...
                            <div class="swiper-button-next documents-next"></div>
                            <div class="swiper-button-prev documents-prev"></div>
                        </div>
        ...
        <?php endif; ?>
        <section class="payments" <?php if ($payments_bg_style): ?> style="<?php echo $payments_bg_style; ?>" <?php endif; ?>>
            <div class="information">
                <div class="text">
                    <?php if ($payments_title): ?><h3><?php echo esc_html($payments_title); ?></h3><?php endif; ?>
                    <?php if ($payments_subtitle): ?><h2><?php echo esc_html($payments_subtitle); ?></h2><?php endif; ?>
                    <?php if ($payments_text): ?><p><?php echo $payments_text; ?></p><?php endif; ?>
                </div>
                <?php if ($payments_btn_text && $payments_btn_link): ?>
                    <a class="btn" href="<?php echo esc_url($payments_btn_link); ?>"><?php echo esc_html($payments_btn_text); ?></a>
                <?php endif; ?>
            </div>
            <figure class="diamond">
                <div class="diamond-shape">
                    <div class="left" <?php if ($diamond_image): ?> style="background-image: url('<?php echo esc_url($diamond_image); ?>'); background-size: cover; background-position: right center; background-repeat: no-repeat;" <?php endif; ?>></div>
                    <div class="right"></div>
                </div>
            </figure>
        </section>
