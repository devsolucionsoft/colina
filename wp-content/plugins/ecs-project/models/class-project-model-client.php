...
class Project_Model_Client
{
    ...
    function __construct($template_parser)
    {
        ...
        $this->post_type_name = 'ss-client';
        $this->post_type_singular = __('Cliente', 'enigmind');
        $this->post_type_plural = __('Clientes', 'enigmind');
    ...
    function metabox_general()
    {
        ...
        $cmb = new_cmb2_box(array(
            'id'           => $prefix . 'general',
            'title'        => __('Información del Cliente', 'enigmind'),
